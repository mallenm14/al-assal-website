...
const AboutUs = () => {
  return (
    <div className='min-h-screen flex flex-col w-full pt-18 overflow-hidden'>
      <section className='w-full max-w-[2560px] mx-auto bg-white'>
        <div className='h-[50vh] w-full overflow-hidden relative flex'>
          ...
          <div className='absolute bg-[repeating-linear-gradient(to_bottom_right,transparent_300px,#607189_1000px)] w-full h-full opacity-10 pointer-events-none -skew-24'></div>
          </div>
          ...
          <Image fill src="/images/about/AAMI.jpg" alt="Al Assal Recruitment Team" className='absolute m-auto right-[-9999px] left-[-9999px] top-[-9999px] bottom-[-9999px] brightness-90 object-cover' />
          </div>
        </div>
      </section>
      ...
      <section className='w-full max-w-[2560px] py-20 px-16 lg:px-24 bg-[#E7E7E7]'>
        ...
        <div className='w-full flex-1 bg-white max-h-[400px] overflow-hidden shadow-lg slidedown'>
        <div className='h-[200px] w-full bg-secondary relative'>
        ...
        <div className='w-full flex-1 bg-white max-h-[400px] shadow-lg slidedown'>
        <div className='h-[200px] w-full bg-secondary relative'>
      ...
      <div className='flex flex-col lg:grid grid-cols-3 grid-rows-6 gap-5 px-10 pb-20 lg:px-30 w-[80vw] mx-auto'>
        ...
        <div className='col-span-1 row-span-3 bg-gray-100 shadow-lg px-10 py-5 flex flex-col justify-evenly slidedown'>
          <h5 className='text-xl font-bold text-secondary'>Computerized Talent Bank</h5>
        ...
        <div className='col-span-1 row-span-2 bg-gray-100 shadow-lg px-10 py-5 flex flex-col justify-evenly slideleft'>
          <h5 className='text-xl font-bold text-secondary'>Technology</h5>
        ...
        <div className='col-span-1 row-span-2 bg-gray-100 shadow-lg px-10 py-5 flex flex-col justify-evenly slideleft'>
        <h5 className='text-xl font-bold text-secondary'>Delivery Capability</h5>
        ...
        <div className='col-span-1 row-span-3 bg-gray-100 shadow-lg px-10 py-5 flex flex-col justify-evenly slideup'>
        <h5 className='text-xl font-bold text-secondary'>Recruitment Team</h5>
        ...
        <div className='col-span-1 row-span-2 bg-gray-100 shadow-lg px-10 py-5 flex flex-col justify-evenly slideleft'>
        <h5 className='text-xl font-bold text-secondary'>Management Team</h5>
      ...
      <section className='w-full bg-white py-10'>
        ...
        <div className='flex flex-col lg:grid grid-cols-3 place-items-center border-t border-cerulian mt-10'>
          <div className='p-10 flex flex-col text-center justify-center items-center'>
            <h6 className='text-xl font-bold text-secondary-strong'>Arlene D. Alimorong, CBA</h6>
            <p className='text-secondary-pale font-semibold'>President/General Manager
            </p>
          </div>
          <div className='p-10 flex flex-col text-center justify-center items-center'>
            <h6 className='text-xl font-bold text-secondary-strong'>Enrg. Ricardo G. Vidal</h6>
            <p className='text-secondary-pale font-semibold'>Technical Manager
            </p>
          </div>
          <div className='p-10 flex flex-col text-center justify-center items-center'>
            <h6 className='text-xl font-bold text-secondary-strong'>Gilbert R. Atienza</h6>
            <p className='text-secondary-pale font-semibold'>Project In Charge Electromechanical Industry
            </p>
          </div>
          <div className='p-10 flex flex-col text-center justify-center items-center'>
            <h6 className='text-xl font-bold text-secondary-strong'>Nasrimah M. Alamada, LPT</h6>
            <p className='text-secondary-pale font-semibold'>Legal and Welfare Officer
            </p>
          </div>
          <div className='p-10 flex flex-col text-center justify-center items-center'>
            <h6 className='text-xl font-bold text-secondary-strong'>Mohamed A. Mohamed, MBA</h6>
            <p className='text-secondary-pale font-semibold'>Overseas Marketing Consultant
            </p>
          </div>
          <div className='p-10 flex flex-col text-center justify-center items-center'>
            <h6 className='text-xl font-bold text-secondary-strong'>Tahani F. Al Assal, MD, MBAHHM</h6>
            <p className='text-secondary-pale font-semibold'>Treasurer/HR Manager
            </p>
          </div>
          <div className='p-10 flex flex-col text-center justify-center items-center'>
            <h6 className='text-xl font-bold text-secondary-strong'>Ramon C. Carcer</h6>
            <p className='text-secondary-pale font-semibold'>Recruitment Manager
            </p>
          </div>
          <div className='p-10 flex flex-col text-center justify-center items-center'>
            <h6 className='text-xl font-bold text-secondary-strong'>Iris L. Matienzo</h6>
            <p className='text-secondary-pale font-semibold'>Processing Head
            </p>
          </div>
          <div className='p-10 flex flex-col text-center justify-center items-center'>
            <h6 className='text-xl font-bold text-secondary-strong'>Mirasol S. Conejos, aMBA</h6>
            <p className='text-secondary-pale font-semibold'>Corporate Social Responsibility
            </p>
          </div>
        </div>
        </div>
